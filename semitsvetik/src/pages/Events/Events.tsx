    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.content}>
                <p>Вы можете интегрировать наш календарь мероприятий в свой Гугл-календарь и быть в курсе всех предстоящих событий. Для этого нажмите <b>"Добавить в Календарь Google"</b> в нижнем левом углу календаря.</p>
